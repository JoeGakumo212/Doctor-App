  ...
  return (
    <div className="py-[30px] px-3 lg:px-5">
      ...
      <div className="flex items-center justify-between mt-[30px]">
        ...
        <span className="w-[44px] h-[44px] flex items-center justify-center text-[19px] leading-[30px] font-[600]" style={{background:`${bgColor}`,color:`${textColor}`,borderRadius:"6px 0 0 6px",}}>{index +1}</span>
      </div>
    </div>
  );
