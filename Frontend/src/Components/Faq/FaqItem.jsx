...
const FaqItem = ({ item }) => {
  ...
  return (
    <div className="p-3 lg:p-5 rounded-[12px] border border-solid border-[#d9dec2] mb-5 cursor-pointer">
    ...
    {isOpen && <div className="mt-4">
        <p className="text-[15px] leading-6 lg:text-[16px] lg:leading-7 font-[400] text-textColor">{item.content}</p>
        </div>}
